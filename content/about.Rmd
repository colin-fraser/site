...
My name is Colin. I currently work as a Data Science Manager at Twitter. I work on the team that tries to keep the conversation on Twitter healthy, and I primarily deal with the problems of misinformation and election safety I do a whole lot of my work with R, but I also like to use Python for some things. I do a little bit of teaching on the side. I’ll write about all kinds of different things here.
