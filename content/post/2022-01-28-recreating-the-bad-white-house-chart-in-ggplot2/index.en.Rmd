...
<iframe src="https://data.worldbank.org/share/widget?end=2020&indicators=NY.GDP.MKTP.KD.ZG&locations=US&start=1961&view=chart" width='450' height='300' frameBorder='1' scrolling="no" ></iframe>
...
I would strongly recommend against ever having a plot axis which changes scales abruptly partway through the axis. However, I do think it's valuable to peek inside ggplot2 and figure out how everything works, and there are lots of transformations you could apply to a plot that would be valuable and insightful.