...
- Specifically, I show that of $\pi$ is the prevalence of the positive class and $u_{TP}, u_{TN}, u_{FP}, u_{FN}$ are utilities associated with True Positives, True Negatives, False Positives, and False Negatives, then you should choose a point on the ROC curve which satisfies
