...
The dataset that I'm using can be viewed and downloaded below.
...
You can view the source code for this post [on GitHub](http://github.com/colin-fraser/site/tree/master/content/post/2020-03-30-case-data-first-look.Rmd).
