...
Each puzzle has input data conveniently stored at a URL that looks like `adventofcode.com/{year}/day/{day}/input` where `year` is the year you're working on and `day` is the day you're working on.
