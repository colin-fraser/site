...
But since I don't package them, I end up just forgetting about them until the next time I need them, at which point I rewrite them but with subtle variations. This is confusing and bad, so I'm now packaging them together into [a package](https://github.com/colin-fraser/colinlib).
