...
fig_1 <- function(alpha = .7, beta = .2, wrapwidth = 70) {
  ...
  ggplot() +
    ...
    labs(y = "Estimated prevalence ℓ", x = "Actual prevalence μ", color = "Labeler", fill = "Direction of bias", title = "Apparent versus actual prevalence", caption = caption) +
    theme_minimal() +
...
### Some references on this from the literature
